...
#: 포털이 자료를 주기 시작하는 시점. **2026-09-19 실측값** — ``probe-start`` 이분 탐색
#: 34회로 확인했다. 2019-12-27 주는 0건, 2019-12-30 주부터 자료가 있다. 2019년 마지막
#: 거래일(12-30)까지 포함하도록 그 주 월요일을 시작으로 잡는다 — 12-31 은 휴장이라 0건이다.
DEFAULT_START = date(2019, 12, 30)
